...
var WheelIndicator = (function(win, doc) {
    ...
    function processDelta(event, timeout) {
        ...
        var maxTimeOut = ({ Chrome: 100, Firefox: 300 })[self._browser];
            ...
            if(l > 4) {
                    ...
                    if((d2 < d1 && d2 < d3) || (t2 > t1 && t2 > t3)) {
                        ...
                        if(d2 < d1 && d2 < d3) {
                            ...
                            if((t2 > t1 || t2 > t3) && (dc > d1) && (d2 < d1 || d2 < d3)) {
                                counter = 6
                        ...
                        if(t2 > t1 && t2 > t3) {
                            ...
                            //d1 "1 - 8
                            //dc "8 - 30
                            if((d2 === d1) && (d3 > d2) && ((t2 / t1 > 2) && (t2 / t3 > 2))) {
                            ...
                            //d1 "1 - 2
                            //dc "1 - 7
                            if((d2 === d1) && (d3 > d2) && ((t2 > t1) && (t2 > t3)) && ((t2 / t1 > 5) || (t2 / t3 > 5))) {
                                counter = 6
