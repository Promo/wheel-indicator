...
var WheelIndicator = (function(win, doc) {
    ...
    function processDelta(event, timeout) {
        ...
        if(self._browser === 'Firefox') {
            if(l > 4) {
                if(
                    (t2 > t1 && t2 > t3) && (d2 < d1 && d2 < d3) &&
                    !((dc < 10) && (d1 < 10) && (d2 < 10) && (d3 < 10) && (d4 < 10)) && // блоккер 1.1
                    !((d2 > 2) && (d3 / d2 < 5) && (d4 / d3 < 2)) //блоккер 1.2
                ) {
                ...
                if(d2 < d1 && d2 < d3) {
                    ...
                    if(
                        ...
                        !((d2 > 2) && (d3 / d2 < 5) && (d4 / d3 < 2)) //блоккер 1.3
                    ) {
                        counter = 6
                ...
                if(t2 > t1 && t2 > t3) {
                    ...
                    if(
                        ...
                        (dc > 10 || d1 > 10 || d2 > 10 || d3 > 10 || d4 > 10) //блоккер 1.4
                    ) {
                        counter = 6;
                    ...
                    if(
                        ...
                        (dc > 10 || d1 > 10 || d2 > 10 || d3 > 10 || d4 > 10) //блоккер 1.5
                    ) {
                        counter = 6;
                ...
                if(dc < 10 && d1 < 10 && d2 < 10 && d3 < 10 && d4 < 10 && (dc + d1 + d2 + d3 + d4 < 30)) {
                    if(
                        ((d2 === 1) && (d3 >= d2) && (d4 >= d3) && (d4 > d2) && (d1 >= d2) && (dc >= d1) && (dc > d2)) &&
                        ((t2 / t3 > 2) && (t2 / t1 > 2) && (( t2 / (t4 + tc)) > 2) && (t2 > 20))
                    ) {
                        counter = 6;
                        event.scheme = '12: micro gesture';
                    }
                    ...
                    if((d2 === 1) && (d1 >= 1) && (dc >= 1) && (t2 / t1 > 2) && (t2 / t3 > 2) && (t2 / t4 > 2) && (t2 / tc > 2) && (d3 > d2)) {
                        counter = 6;
                        event.scheme = '21: micro gesture';
                    }
